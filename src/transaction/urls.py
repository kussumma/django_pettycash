...
from .views import TransactionView, TransactionAjaxView, PurchaseCategoryAjaxView
...
urlpatterns = [
    ...
    path('ajax/update', TransactionAjaxView.as_view(), name='transaction_ajax_update'),
